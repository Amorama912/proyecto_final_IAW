...
<body>
    ...
    $sql = "INSERT INTO operacion (id_cuenta,cantidad,tipo) VALUES('$id_cuenta','$cantidad','retiro')";
    ...
    if ($resultado > 0) {
        $mysqli->close();
        echo "<div class='alert alert-primary' role='alert'><p>Retiro efectuado</p></div>";
